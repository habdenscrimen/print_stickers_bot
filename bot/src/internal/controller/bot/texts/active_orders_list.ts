...
export const activeOrdersListText = (options: Options): Text => {
  try {
...
${ordersMessage}
  `,
    ...
    console.error(`failed to create active orders list text: ${error}`)
    throw new Error(`failed to create active orders list text: ${error}`)
  }
}
