...
export const config = {
  ...
  messages: {
    scenes: {
      ...
      confirmStickers: {
        checkStickerpack: `Я зібрав усі обрані стікери у пак — перевір, чи правильні стікери вибрані`,
        aftercheckStickerpack: `Як перевіриш, продовжимо`,
  ...
  tempStickerSetName: `Твої стікери`,
}
