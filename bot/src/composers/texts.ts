...
export const texts = {
  ...
  menus: {
    main: {
      ...
      referralLinkButton: `Реферальна програма`,
      ...
      referralLink: (referralCode: string, freeStickersCount: number) =>
        `\`https://t.me/print_stickers_ua_bot?start=${referralCode}\`\n\n(натисни щоб скопіювати)\n\nКоли хтось зареєструється за цим посиланням і зробить перше замовлення, ви удвох отримаєте по 3 безкоштовних стікера 🔥\n\nБезкоштовних стікерів: ${freeStickersCount}`,
    },
    selectStickers: {
